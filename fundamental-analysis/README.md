...
1. **Handbook** (structured learning): The [Fundamental Analysis Handbook](handbook/README.md) covers all core topics in depth — financial statements, ratios, valuation, competitive analysis, macro, and earnings.
2. **Book Notes**: Detailed notes from classic texts—start with [Book Notes README](book-notes/README.md) and pick by level (beginner → advanced).
3. **Summary:** Condensed overview of FA and how it fits with TA and Options: [Fundamental Analysis Summary](summary.md).
4. **Tips and Tricks:** Practical guidance on statements, ratios, valuation, red flags, and workflow: [Fundamental Analysis Tips](tips-and-tricks.md).
