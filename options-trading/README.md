...
1. **Handbook** (structured learning): The [Options Trading Handbook](handbook/README.md) covers all core topics — foundations, Greeks, volatility, strategies, risk management, and combining with TA/FA.
2. **Book Notes**: In-depth notes from options classics—[Book notes README](book-notes/README.md). Start with beginner (Options Made Easy, Options Playbook) then move to Greeks and volatility (Trading Options Greeks, Options Volatility and Pricing).
3. **Summary:** Condensed overview of options (Greeks, strategies, risk, IV): [Options Trading Summary](summary.md).
4. **Tips and Tricks:** Practical tips on Greeks, expiration, IV, strategy choice, and risk: [Options Trading Tips](tips-and-tricks.md).
